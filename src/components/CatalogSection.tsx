...
const CatalogSection = () => {
  useGSAP(() => {
    const titleSplit = SplitText.create(".hero-header", {
      type: "chars",
    });
    ...
    <>
      ...
      <section className="w-full bg-[#0a0a0a] px-4 py-24 md:px-8">
        <div className="mx-auto mb-16 max-w-[1200px]">
          <h1 className="hero-header text-6xl font-black tracking-tighter text-white uppercase italic md:text-8xl">
            The Lineup
          </h1>
          <div className="hero-content mt-4 flex flex-col gap-4 opacity-0 transition-all md:flex-row md:items-end md:justify-between">
            <p className="max-w-md text-sm leading-relaxed text-white/50">
              From the golden era of double-wishbone suspension to the modern
              turbocharged powerhouses—explore the evolution of the Honda Civic.
              Select a generation to start your build.
            </p>
            <div className="h-[1px] flex-1 bg-gradient-to-r from-red-900/50 to-transparent md:mx-8 md:mb-2" />
            <span className="text-[10px] font-bold tracking-[0.3em] text-red-500 uppercase">
              Performance Catalog v2.6
            </span>
          </div>
        </div>
